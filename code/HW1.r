...
save(All_data, file = "./data/All_data_wide.csv")
save(All_data_long, file = "./data/All_data_long.csv")
...
ggsave("./figures/fig1.jpeg", width = 10, height = 5)
...
ggsave("./figures/fig2.jpeg", width = 10, height = 5)
...
ggsave("./figures/fig3.jpeg", width = 10, height = 5)
